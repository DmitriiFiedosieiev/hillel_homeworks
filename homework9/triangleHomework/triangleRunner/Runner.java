package com.hillel.homework9.triangleHomework.triangleRunner;

import com.hillel.homework9.triangleHomework.triangleProcesses.TriangleProcessor;
...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(processor.countIsosceles());
        System.out.println(processor.countArbitrary());
        System.out.println(processor.countEquilateral());
        System.out.println(processor.countRectangular());
        System.out.println(processor.showBiggestPerimeterOfEquilateral());
    }
}
