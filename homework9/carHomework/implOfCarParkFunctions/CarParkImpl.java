package com.hillel.homework9.carHomework.implOfCarParkFunctions;

import com.hillel.homework9.carHomework.carModels.Car;
import com.hillel.homework9.carHomework.carParkFunctions.CarPark;

public class CarParkImpl implements CarPark {

    private Car[] cars;

    public CarParkImpl(Car[] cars) {
        this.cars = cars;
    }
