...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        TriangleProcessor proc = new TriangleProcessor();
        System.out.println(proc.sortByTypes(triangles));
        System.out.println();

        TriangleContainer container = proc.sortByTypes(triangles);
        container.getBiggestPerimeterForEach();
        System.out.println();
        container.getBiggestAreaForEach();
        System.out.println();
        container.getSmallestPerimeterForEach();
        System.out.println();
        container.getSmallestAreaForEach();
        System.out.println();
